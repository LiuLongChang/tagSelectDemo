...
-(void)loaderData{
    ...
    NSArray *tags = @[@{@"id" : @"1", @"title" : @"头条", @"isSelect": @"1"},
                      ...
                      @{@"id" : @"7", @"title" : @"军事", @"isSelect": @"1"},
                      @{@"id" : @"8", @"title" : @"文化", @"isSelect": @"1"},
                      @{@"id" : @"9", @"title" : @"视频", @"isSelect": @"0"},
                      @{@"id" : @"10", @"title" : @"体育", @"isSelect": @"0"},
                      @{@"id" : @"11", @"title" : @"卡通", @"isSelect": @"0"},
                      @{@"id" : @"12", @"title" : @"汽车", @"isSelect": @"0"},@{@"id" : @"1", @"title" : @"头条", @"isSelect": @"1"},
                      @{@"id" : @"13", @"title" : @"专题", @"isSelect": @"1"},
                      @{@"id" : @"14", @"title" : @"当代艺术", @"isSelect": @"0"},
                      @{@"id" : @"15", @"title" : @"书画1", @"isSelect": @"0"},
                      @{@"id" : @"16", @"title" : @"摄影2", @"isSelect": @"0"},
                      @{@"id" : @"17", @"title" : @"人物3", @"isSelect": @"0"},
                      @{@"id" : @"18", @"title" : @"军事4", @"isSelect": @"1"},
                      @{@"id" : @"19", @"title" : @"文化5", @"isSelect": @"1"},
                      @{@"id" : @"20", @"title" : @"视频6", @"isSelect": @"0"},
                      @{@"id" : @"21", @"title" : @"体育7", @"isSelect": @"0"},
                      @{@"id" : @"22", @"title" : @"卡通8", @"isSelect": @"0"},
                      @{@"id" : @"23", @"title" : @"汽车11", @"isSelect": @"0"},
                      ];
